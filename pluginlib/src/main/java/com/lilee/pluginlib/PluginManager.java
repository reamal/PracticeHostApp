...
public class PluginManager {
    ...
    public static final String FIRST_PLUGIN_NAME = "firstPlugin.apk";
    public static final String SECOND_PLUGIN_NAME = "secondPlugin.apk";




    public final static HashMap<String, PluginItem> plugins = new HashMap<>();
