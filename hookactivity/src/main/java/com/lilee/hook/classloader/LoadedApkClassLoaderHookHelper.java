package com.lilee.hook.classloader;
...
public class LoadedApkClassLoaderHookHelper {
    ...
    public static void hookLoadedApkInActivityThread(Context context, File apkFile) throws ClassNotFoundException,
        ...
        //为插件造一个新的ClassLoader
        String odexPath = Utils.getPluginOptDexDir(context,applicationInfo.packageName).getPath();
        String libDir = Utils.getPluginLibDir(context,applicationInfo.packageName).getPath();
